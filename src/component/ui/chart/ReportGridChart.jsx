...
const Veil = styled.div`
  ...
  visibility: hidden;
  width: 100%;
  // 부모 높이 100% 에서 strip 의 eventTimestamp 표현 영역 높이 19px 배제
...
const generateChartOptions = (data = [], theme, isRecommended) => {
  return {
    chart: {
...
function ReportGridChart(props) {
  const {
    //
    data,
    isRecommended,
  ...
  return (
    <Wrapper>
      ...
      <HighchartsReact
        ...
        options={generateChartOptions(data, theme, isRecommended)}
        allowChartUpdate={true}
        immutable={false}
        updateArgs={[false, false, false]}
        containerProps={{
          className: 'chartContainerNoPadding',
          style: {
            width,
...
export default ReportGridChart;
